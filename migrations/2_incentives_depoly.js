...
const deployParams = {
    'mumbai': {
        ...
        'mcoin': '0xBcEB584cf06e1f67b5654ef4b3Dd4dE4fA3617Dd',             // the address of mcoin
        'duration': 10                                                     // the duration of incentive (unit: year)
    },
    "bsc_testnet": {
        'contract': '0x8BFD915c545559a8272ab2a1aA1c01BE56F3C1dC',
        'mcoin': '0x1F63A75C6C77612Fb9264aF3FED5A0f2766807d7',
        'duration': 10
    },
    "bsc": {
        'contract': null,
...
module.exports = async function (deployer, network, accounts) {
    ...
    if ( deployParams[network]['contract'] == null ) {
        ...
        await deployer.deploy(MetaLoanIncentivesController,
                              deployParams[network]['mcoin'],
                              emissionManager,
                              duration,
                              {from: owner});
    }
        ...
        var mcoinIns = await ERC20.at(deployParams[network]['mcoin']);
        var balance = new BigNumber(await mcoinIns.balanceOf(deployParams[network]['contract']));
        var decimals = new BigNumber(await mcoinIns.decimals());
